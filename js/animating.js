...
"use strict";
    ...
    function init(options) {
        ...
        $(".lmpixels-arrow-right").click(function() {
            ...
            activeItem.next("li:not(.external)").children("a:not(.external)").click();
        ...
        $(".lmpixels-arrow-left").click(function() {
            var activeItem = $('.main-menu a.active').parent("li");
            activeItem.prev("li:not(.external)").children("a:not(.external)").click();
            if ( activeItem.is(':first-child') ) {
                $('.main-menu li:not(.external):last-child').children("a").click();
            }
        });
    }
